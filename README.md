...
### Membuat Database
1. Pilih menu `Databases` lalu masukan nama file tersebut (latihan1) dan klik Create.

2. Ataupun bisa juga pilih menu `SQL` lalu jalankan perintah berikut.

```sql
CREATE DATABASE latihan1;
```

3. Kemudian buat `Table` dengan cara klik menu `SQL` lagi, kemudian masukan perintah berikut.
...
4. Setelah itu, Tambahkan data dalam table tersebut dengan memasukan perintah berikut.
...
![Proses-Tambah](img/proses_tambah.PNG)
